...
if [ ! -f sirix-shell ]; then
    ...
    NATIVE_IMAGE_OPTS="$NATIVE_IMAGE_OPTS --enable-preview --add-modules=jdk.incubator.vector --initialize-at-build-time=ch.qos.logback --initialize-at-build-time=org.slf4j.LoggerFactory --initialize-at-build-time=org.slf4j.helpers.NOPLoggerFactory --initialize-at-build-time=org.slf4j.helpers.SubstituteLoggerFactory"
