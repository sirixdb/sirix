...
We not only support snapshot based versioning on a record granular level through a novel versioning algorithm called sliding snapshot, but also support time travel queries, efficient diffing between revisions...
