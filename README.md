...
- Log-structured writes and random reads due to transactional copy-on-write (COW) semantics. This offers nice benefits as for instance no locking for reading-transactions and it takes full advantage of flash disks as for instance SSDs.
