...
public final class ScanPathIndex extends AbstractFunction {
  ...
  public final static QNm DEFAULT_NAME =
      new QNm(SDBFun.SDB_NSURI, SDBFun.SDB_PREFIX, "scan-path-index");
  ...
  public Sequence execute(StaticContext sctx, QueryContext ctx, Sequence[] args)
    ...
    final PathFilter filter =
        (paths != null) ? controller.createPathFilter(paths.split(";"), doc.getTrx()) : null;
          ...
          public Item next() throws QueryException {
            if (s == null) {
              s = new SirixNodeKeyStream(
                  ic.openPathIndex(node.getTrx().getPageTrx(), indexDef, filter),
