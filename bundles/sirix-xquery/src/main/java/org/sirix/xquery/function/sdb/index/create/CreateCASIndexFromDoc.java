 ...
 * 
 */
public final class CreateCASIndexFromDoc extends AbstractFunction {

	/** CAS index function name. */
	public final static QNm CREATE_CAS_INDEX_FROM_DOC = new QNm(SDBFun.SDB_NSURI,
			SDBFun.SDB_PREFIX, "create-cas-index-from-doc");
	 ...
	 */
	public CreateCASIndexFromDoc(QNm name, Signature signature) {
