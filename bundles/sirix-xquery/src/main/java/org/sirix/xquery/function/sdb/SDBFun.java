...
import static org.sirix.xquery.function.sdb.index.node.SortByDocOrder.SORT;
import static org.sirix.xquery.function.sdb.index.node.create.CreateCASIndex.CREATE_CAS_INDEX;
import static org.sirix.xquery.function.sdb.index.node.create.CreateNameIndex.CREATE_NAME_INDEX;
import static org.sirix.xquery.function.sdb.index.node.create.CreatePathIndex.CREATE_PATH_INDEX;
import static org.sirix.xquery.function.sdb.index.node.find.FindCASIndex.FIND_CAS_INDEX;
import static org.sirix.xquery.function.sdb.index.node.find.FindNameIndex.FIND_NAME_INDEX;
import static org.sirix.xquery.function.sdb.index.node.find.FindPathIndex.FIND_PATH_INDEX;
import static org.sirix.xquery.function.sdb.io.node.Doc.DOC;
import static org.sirix.xquery.function.sdb.io.node.DocByPointInTime.OPEN;
import static org.sirix.xquery.function.sdb.io.node.Import.IMPORT;
import static org.sirix.xquery.function.sdb.io.node.Load.LOAD;
import static org.sirix.xquery.function.sdb.io.node.OpenRevisions.OPEN_REVISIONS;
import static org.sirix.xquery.function.sdb.io.node.Store.STORE;
...
import org.sirix.xquery.function.sdb.index.node.SortByDocOrder;
import org.sirix.xquery.function.sdb.index.node.create.CreateCASIndex;
import org.sirix.xquery.function.sdb.index.node.create.CreateNameIndex;
import org.sirix.xquery.function.sdb.index.node.create.CreatePathIndex;
import org.sirix.xquery.function.sdb.index.node.find.FindCASIndex;
import org.sirix.xquery.function.sdb.index.node.find.FindNameIndex;
import org.sirix.xquery.function.sdb.index.node.find.FindPathIndex;
import org.sirix.xquery.function.sdb.index.node.scan.ScanCASIndex;
import org.sirix.xquery.function.sdb.index.node.scan.ScanCASIndexRange;
import org.sirix.xquery.function.sdb.index.node.scan.ScanNameIndex;
import org.sirix.xquery.function.sdb.index.node.scan.ScanPathIndex;
import org.sirix.xquery.function.sdb.io.Serialize;
import org.sirix.xquery.function.sdb.io.node.Doc;
import org.sirix.xquery.function.sdb.io.node.DocByPointInTime;
import org.sirix.xquery.function.sdb.io.node.Import;
import org.sirix.xquery.function.sdb.io.node.Load;
import org.sirix.xquery.function.sdb.io.node.OpenRevisions;
import org.sirix.xquery.function.sdb.io.node.Store;
