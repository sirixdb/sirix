...
(out/'protocol.json').write_text(json.dumps({'scope':'extra-try steering experiment; never published or full-suite score','queries':[2,3,6,21,42],'tries':33,'power_uw':50000000,'cache':'natural; no eviction','source':'unchanged aa4d81d54 compiled runtime','context':'selected fast-query cohort, not the preceding full-suite history'},indent=2)+'\n')
