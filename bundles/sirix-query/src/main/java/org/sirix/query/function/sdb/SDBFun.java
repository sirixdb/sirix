package org.sirix.query.function.sdb;
...
import org.sirix.query.function.sdb.trx.*;
import org.sirix.query.function.xml.diff.Diff;
import org.sirix.query.function.xml.index.SortByDocOrder;
import org.sirix.query.function.xml.index.create.CreateCASIndex;
import org.sirix.query.function.xml.index.create.CreateNameIndex;
import org.sirix.query.function.xml.index.create.CreatePathIndex;
import org.sirix.query.function.xml.index.find.FindCASIndex;
import org.sirix.query.function.xml.index.find.FindNameIndex;
import org.sirix.query.function.xml.index.find.FindPathIndex;
import org.sirix.query.function.xml.index.scan.ScanCASIndex;
import org.sirix.query.function.xml.index.scan.ScanCASIndexRange;
import org.sirix.query.function.xml.index.scan.ScanNameIndex;
import org.sirix.query.function.xml.index.scan.ScanPathIndex;
import org.sirix.query.function.xml.io.*;
import org.sirix.query.function.xml.trx.GetNamespaceCount;

import static org.sirix.query.function.sdb.trx.Commit.COMMIT;
import static org.sirix.query.function.sdb.trx.GetAuthorID.AUTHOR_ID;
import static org.sirix.query.function.sdb.trx.GetAuthorName.AUTHOR_NAME;
import static org.sirix.query.function.sdb.trx.GetChildCount.GET_CHILD_COUNT;
import static org.sirix.query.function.sdb.trx.GetDescendantCount.GET_DESCENDANT_COUNT;
import static org.sirix.query.function.sdb.trx.GetHash.HASH;
import static org.sirix.query.function.sdb.trx.GetMostRecentRevision.MOST_RECENT_REVISION;
import static org.sirix.query.function.sdb.trx.GetRevision.REVISION;
import static org.sirix.query.function.sdb.trx.GetRevisionTimestamp.TIMESTAMP;
import static org.sirix.query.function.sdb.trx.IsDeleted.IS_DELETED;
import static org.sirix.query.function.sdb.trx.ItemHistory.NODE_HISTORY;
import static org.sirix.query.function.sdb.trx.LevelOrder.LEVEL_ORDER;
import static org.sirix.query.function.sdb.trx.Rollback.ROLLBACK;
import static org.sirix.query.function.xml.diff.Diff.DIFF;
import static org.sirix.query.function.xml.index.SortByDocOrder.SORT;
import static org.sirix.query.function.xml.index.create.CreateCASIndex.CREATE_CAS_INDEX;
import static org.sirix.query.function.xml.index.create.CreateNameIndex.CREATE_NAME_INDEX;
import static org.sirix.query.function.xml.index.create.CreatePathIndex.CREATE_PATH_INDEX;
import static org.sirix.query.function.xml.index.find.FindCASIndex.FIND_CAS_INDEX;
import static org.sirix.query.function.xml.index.find.FindNameIndex.FIND_NAME_INDEX;
import static org.sirix.query.function.xml.index.find.FindPathIndex.FIND_PATH_INDEX;
import static org.sirix.query.function.xml.io.Doc.DOC;
import static org.sirix.query.function.xml.io.DocByPointInTime.OPEN;
import static org.sirix.query.function.xml.io.Import.IMPORT;
import static org.sirix.query.function.xml.io.Load.LOAD;
import static org.sirix.query.function.xml.io.OpenRevisions.OPEN_REVISIONS;
import static org.sirix.query.function.xml.io.Store.STORE;
import static org.sirix.query.function.xml.trx.GetAttributeCount.GET_ATTRIBUTE_COUNT;
import static org.sirix.query.function.xml.trx.GetNamespaceCount.GET_NAMESPACE_COUNT;
...
public final class SDBFun {
  ...
  static {
    ...
    Functions.predefine(new Commit(COMMIT,
