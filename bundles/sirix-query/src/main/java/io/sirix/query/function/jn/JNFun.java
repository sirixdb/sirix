...
public final class JNFun {
	...
	static {
		...
		Functions.predefine(new Future(Future.FUTURE, new Signature(SequenceType.JSON_ITEM_SEQUENCE,
				SequenceType.JSON_ITEM, new SequenceType(AtomicType.BOOL, Cardinality.One))));
		Functions
				.predefine(new Past(Past.PAST, new Signature(SequenceType.JSON_ITEM_SEQUENCE, SequenceType.JSON_ITEM)));
		Functions.predefine(new Past(Past.PAST, new Signature(SequenceType.JSON_ITEM_SEQUENCE, SequenceType.JSON_ITEM,
				new SequenceType(AtomicType.BOOL, Cardinality.One))));
		Functions.predefine(new Next(Next.NEXT, new Signature(
				new SequenceType(AnyJsonItemType.ANY_JSON_ITEM, Cardinality.ZeroOrOne), SequenceType.JSON_ITEM)));
		Functions.predefine(new Previous(Previous.PREVIOUS, new Signature(
				new SequenceType(AnyJsonItemType.ANY_JSON_ITEM, Cardinality.ZeroOrOne), SequenceType.JSON_ITEM)));
		Functions.predefine(new First(First.FIRST, new Signature(
				new SequenceType(AnyJsonItemType.ANY_JSON_ITEM, Cardinality.ZeroOrOne), SequenceType.JSON_ITEM)));
		Functions.predefine(new FirstExisting(FirstExisting.FIRST_EXISTING, new Signature(
				new SequenceType(AnyJsonItemType.ANY_JSON_ITEM, Cardinality.ZeroOrOne), SequenceType.JSON_ITEM)));
		Functions.predefine(new Last(Last.LAST, new Signature(
				new SequenceType(AnyJsonItemType.ANY_JSON_ITEM, Cardinality.ZeroOrOne), SequenceType.JSON_ITEM)));
		Functions.predefine(new LastExisting(LastExisting.LAST_EXISTING, new Signature(
				new SequenceType(AnyJsonItemType.ANY_JSON_ITEM, Cardinality.ZeroOrOne), SequenceType.JSON_ITEM)));
		...
		Functions.predefine(new FindNameIndex(FIND_NAME_INDEX, new Signature(SequenceType.INTEGER,
				SequenceType.JSON_ITEM, new SequenceType(AtomicType.STR, Cardinality.One))));
		...
		// diff
		Functions.predefine(new Diff(Diff.DIFF, new Signature(SequenceType.STRING, SequenceType.STRING,
				SequenceType.STRING, SequenceType.INTEGER, SequenceType.INTEGER)));
		Functions.predefine(new Diff(Diff.DIFF, new Signature(SequenceType.STRING, SequenceType.STRING,
				SequenceType.STRING, SequenceType.INTEGER, SequenceType.INTEGER, SequenceType.INTEGER)));
		Functions.predefine(
				new Diff(Diff.DIFF, new Signature(SequenceType.STRING, SequenceType.STRING, SequenceType.STRING,
						SequenceType.INTEGER, SequenceType.INTEGER, SequenceType.INTEGER, SequenceType.INTEGER)));

		Functions.predefine(new DropDatabase(DropDatabase.DROP_DATABASE,
				new Signature(SequenceType.EMPTY_SEQUENCE, SequenceType.STRING)));
		Functions.predefine(new DropResource(DropResource.DROP_RESOURCE,
				new Signature(SequenceType.EMPTY_SEQUENCE, SequenceType.STRING, SequenceType.STRING)));
		Functions.predefine(new ExistsDatabase(ExistsDatabase.EXISTS_DATABASE,
				new Signature(new SequenceType(AtomicType.BOOL, Cardinality.One), SequenceType.STRING)));
		Functions.predefine(new ExistsResource(ExistsResource.EXISTS_RESOURCE, new Signature(
				new SequenceType(AtomicType.BOOL, Cardinality.One), SequenceType.STRING, SequenceType.STRING)));
	}
}
