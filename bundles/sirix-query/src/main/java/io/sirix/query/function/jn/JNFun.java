...
public final class JNFun {
  ...
  static {
    ...
    Functions.predefine(
        new DropDatabase(DropDatabase.DROP_DATABASE, new Signature(SequenceType.EMPTY_SEQUENCE, SequenceType.STRING)));
    ...
    Functions.predefine(new ExistsResource(ExistsResource.EXISTS_RESOURCE,
        new Signature(new SequenceType(AtomicType.BOOL, Cardinality.One), SequenceType.STRING, SequenceType.STRING)));
  }
}
