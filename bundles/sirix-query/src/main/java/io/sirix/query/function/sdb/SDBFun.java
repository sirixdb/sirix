...
import io.sirix.query.function.sdb.trx.*;
...
public final class SDBFun {
	...
	static {
		...
		Functions.predefine(new GetChildCount(GetChildCount.GET_CHILD_COUNT,
				new Signature(SequenceType.INTEGER, SequenceType.NODE)));
		...
		// get timestamp
		Functions.predefine(new GetRevisionTimestamp(GetRevisionTimestamp.TIMESTAMP,
				new Signature(SequenceType.ITEM, SequenceType.NODE)));
		...
		// revision
		Functions.predefine(
				new GetRevision(GetRevision.REVISION, new Signature(SequenceType.INTEGER, SequenceType.NODE)));
		...
		// find-name-index
		Functions.predefine(new FindNameIndex(FIND_NAME_INDEX, new Signature(SequenceType.INTEGER, SequenceType.NODE,
		...
		Functions
				.predefine(new CreateNameIndex(CREATE_NAME_INDEX, new Signature(SequenceType.NODE, SequenceType.NODE)));
		...
		Functions
				.predefine(new CreatePathIndex(CREATE_PATH_INDEX, new Signature(SequenceType.NODE, SequenceType.NODE)));
		...
		// item-history
		Functions.predefine(new ItemHistory(ItemHistory.NODE_HISTORY,
				new Signature(SequenceType.ITEM_SEQUENCE, SequenceType.ITEM)));
		...
		// author-id
		Functions.predefine(
				new GetAuthorID(GetAuthorID.AUTHOR_ID, new Signature(SequenceType.STRING, SequenceType.NODE)));
	}
}
