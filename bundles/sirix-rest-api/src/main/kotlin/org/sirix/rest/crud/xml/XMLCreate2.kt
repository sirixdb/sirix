...
class XMLCreate2(private val location: Path, private val createMultipleResources: Boolean): AbstractCreateHandler(location, createMultipleResources) {
//    public override suspend fun handle(ctx: RoutingContext): Route {
...
//    }
    ...
    override suspend fun shredder(databaseName: String, resPathName: String, ctx: RoutingContext) {
        val dbFile = location.resolve(databaseName)
