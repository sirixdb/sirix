...
/**
 * Immutable container class for counting descendants, modifications... of one node.
 * 
...
public final class Modification {
  ...
  /** Determines if modifications must be subtracted in {@link ITraverseModel#} or not. */
  ...
  public static final Modification EMPTY_MODIFICATION = new Modification(0, 0, false);
   ...
   */
  public Modification(final int pModifications, final int pDescendants, final boolean pSubtract) {
