...
final class SunburstListContainer implements Comparator<SunburstListContainer>,
   ...
   *          current revision
   */
  public SunburstListContainer(final int pMaxDepth, final int pOldMaxDepth, final List<SunburstItem> pItems,
  ...
  @Override
  public int compare(final SunburstListContainer pFirst, final SunburstListContainer pSecond) {
