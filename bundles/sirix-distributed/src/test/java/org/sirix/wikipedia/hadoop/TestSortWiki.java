...
public final class TestSortWiki extends XMLTestCase {
  ...
  private static final File INPUT = new File("src" + File.separator + "test" + File.separator + "resources"
    + File.separator + "testInput.xml");

  private static final File OUTPUT = new File(TestHelper.PATHS.PATH3.getFile().getParentFile()
    .getAbsolutePath());

  private static final File EXPECTED = new File("src" + File.separator + "test" + File.separator
    + "resources" + File.separator + "testExpected.xml");
  ...
  public void test() throws Exception {
    ...
    final StringBuilder output = TestHelper.readFile(new File(OUTPUT, "part-r-00000"), false);
