...
public interface NodeFactory {
   ...
   * @throws SirixIOException if an I/O error occurs
   */
  PathNode createPathNode(final @Nonnegative long parentKey, final @Nonnegative long leftSibKey,
      final long rightSibKey, final long hash, final QNm name, final Kind kind,
   ...
   * @throws SirixIOException if an I/O error occurs
   */
  PINode createPINode(final @Nonnegative long parentKey, final @Nonnegative long leftSibKey,
  ...
  CommentNode createCommentNode(final @Nonnegative long parentKey,
      ...
      @Nonnull byte[] value, final boolean isCompressed, final Optional<SirixDeweyID> id)
  ...
  ElementNode createElementNode(final @Nonnegative long parentKey,
      ...
      final QNm name, final @Nonnegative long pathNodeKey, final Optional<SirixDeweyID> id)
      throws SirixIOException;
   ...
   * @throws SirixIOException if an I/O error occurs
   */
  TextNode createTextNode(final @Nonnegative long parentKey, final @Nonnegative long leftSibKey,
      final @Nonnegative long rightSibKey, final byte[] value, final boolean isCompressed,
      final Optional<SirixDeweyID> id) throws SirixIOException;
   ...
   * @throws SirixIOException if an I/O error occurs
   */
  AttributeNode createAttributeNode(final @Nonnegative long parentKey, final QNm name,
      final byte[] value, final @Nonnegative long pathNodeKey, final Optional<SirixDeweyID> id)
      throws SirixIOException;
   ...
   * @throws SirixIOException if an I/O error occurs
   */
  NamespaceNode createNamespaceNode(final @Nonnegative long parentKey, final QNm name,
      final @Nonnegative long pathNodeKey, final Optional<SirixDeweyID> id) throws SirixIOException;
}
