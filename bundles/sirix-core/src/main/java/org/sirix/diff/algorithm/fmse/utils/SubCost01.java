...
public final class SubCost01 implements SubstitutionCost {
	...
	/**
	 * Cost between characters where d(i,j) = 1 if i does not equals j, 0 if i
	 * equals j.
	 * 
	 * @param str1
	 ...
	 * @return the cost of a given subsitution d(i,j) where d(i,j) = 1 if i!=j, 0
	 *         if i==j
	 */
	@Override
	public float getCost(final String str1, final int string1Index,
