...
public class LoggerAspect {
	...
	private static final ILoggerFactory FACTORY = LoggerFactory
			.getILoggerFactory();
	...
	public Object advice(ProceedingJoinPoint pjp) throws Throwable {
		...
		logger.debug(new StringBuilder("Entering ").append(
				sig.getDeclaringTypeName()).toString());
		final Object returnVal = pjp.proceed();
		logger.debug(new StringBuilder("Exiting ").append(
				sig.getDeclaringTypeName()).toString());
		return returnVal;
	}
