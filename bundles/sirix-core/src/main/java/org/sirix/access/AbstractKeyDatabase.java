...
/**
 * Abstract class for holding common data for all key databases involved in encryption process. Each
 * instance of this class stores the data in a place related to the {@link DatabaseConfiguration} at
...
public abstract class AbstractKeyDatabase {
	...
	protected AbstractKeyDatabase(final File file) {
		place = new File(file,
				new StringBuilder(DatabaseConfiguration.Paths.KEYSELECTOR.getFile().getName())
