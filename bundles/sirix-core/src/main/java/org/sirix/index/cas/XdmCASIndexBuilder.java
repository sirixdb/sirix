...
final class XdmCASIndexBuilder extends AbstractXdmNodeVisitor {
  ...
  private static final LogWrapper LOGGER = new LogWrapper(LoggerFactory.getLogger(XdmCASIndexBuilder.class));
  ...
  XdmCASIndexBuilder(final XdmNodeReadTrx rtx, final PageWriteTrx<Long, Record, UnorderedKeyValuePage> pageWriteTrx,
