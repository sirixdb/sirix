...
public final class XdmPathIndexImpl implements XdmPathIndex<Long, NodeReferences> {

  @Override
  public XdmPathIndexBuilder createBuilder(final PageWriteTrx<Long, Record, UnorderedKeyValuePage> pageWriteTrx,
      final PathSummaryReader pathSummaryReader, final IndexDef indexDef) {
    return new XdmPathIndexBuilder(new PathIndexBuilderFactory().create(pageWriteTrx, pathSummaryReader, indexDef));
  }

  @Override
  public XdmPathIndexListener createListener(final PageWriteTrx<Long, Record, UnorderedKeyValuePage> pageWriteTrx,
      final PathSummaryReader pathSummaryReader, final IndexDef indexDef) {
    return new XdmPathIndexListener(new PathIndexListenerFactory().create(pageWriteTrx, pathSummaryReader, indexDef));
  }
