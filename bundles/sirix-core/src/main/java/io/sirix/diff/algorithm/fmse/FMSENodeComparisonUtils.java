...
class FMSENodeComparisonUtils {
	 ...
	 * do have child nodes or the name for inner nodes such as element or attribute
	 * (an attribute has one child: the value).
	 *
	 * @param x
	 *            first node
	 * @param y
	 ...
	 * @return {@code true} if all ancestors up to the start keys are considered
	 ...
	 * @param rtx
	 *            {@link XmlNodeReadOnlyTrx} implementation reference
