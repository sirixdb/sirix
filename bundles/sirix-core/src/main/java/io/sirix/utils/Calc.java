...
public final class Calc {
	...
	public static byte[] fromUIntVar(int i) {
		...
		return new byte[]{(byte) ((i >> 24) & 0xFF), (byte) ((i >> 16) & 0xFF), (byte) ((i >> 8) & 0xFF), (byte) i};
	}
	...
	public static long toLong(byte[] b, int off) {
		...
		return ((((long) b[off++] & 0xFF) << 56) | (((long) b[off++] & 0xFF) << 48) | (((long) b[off++] & 0xFF) << 40)
				| (((long) b[off++] & 0xFF) << 32) | (((long) b[off++] & 0xFF) << 24) | (((long) b[off++] & 0xFF) << 16)
	...
	public static byte[] fromLong(long i) {
		return new byte[]{(byte) ((i >> 56) & 0xFF), (byte) ((i >> 48) & 0xFF), (byte) ((i >> 40) & 0xFF),
				(byte) ((i >> 32) & 0xFF), (byte) ((i >> 24) & 0xFF), (byte) ((i >> 16) & 0xFF),
	...
	/**
	 * Nulls in this project are viewed as EOF, thus it is often of interest when
	 * comparing two values which one is greatest to check if one is null or
	 * possible both and return which.
	 *
	 * @param v1
	 *            the first value to be tested.
	 * @param v2
	 *            the second value to be tested.
	 * @return -1, if v2 is null but not v1, 1 for vice versa, 0 for both being
	 *         null, and int max for when neither is null.
	 */
