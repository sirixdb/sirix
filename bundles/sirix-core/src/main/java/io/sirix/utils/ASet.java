...
/**
 * This is the basic structure of an efficient and memory-saving hash set. The
 * first entry of the token set (offset 0) will always be kept empty.
 *
...
public abstract class ASet {
	...
	/**
	 * Returns the number of entries. The actual number of keys may be smaller if
