...
public final class Array {
	/**
	 * Maximum array size (see {@code MAX_ARRAY_SIZE} variable in
	 * {@link ArrayList}).
	 */
	 ...
	 * @param length
	 *            number of valid array entries
	 * @param entries
	 *            entries to be inserted (can be {@code null})
	 */
	 ...
	 *            array
	 * @param index
	 *            index of first entry to be removed
	 * @param del
	 ...
	 * @param length
	 *            number of array entries to be copied
	 * @param target
	 *            target array
	 * @param trgIndex
	 ...
	 *
	 * @param size
	 *            size expected result size (ignored if negative)
	 * @return capacity
	 */
	...
	/**
	 * Returns a value for a new array size, which will always be larger than the
	 * old size. The returned value will not exceed the maximum allowed array size.
	 ...
	 *
	 * @param arr1
	 *            first array (can be {@code null})
	 * @param arr2
	 *            second array (can be {@code null})
