...
public final class Compression {
	 ...
	 *             if {@code toCompress} is {@code null}
	 */
	public static byte[] compress(final byte[] toCompress, final int level) {
		...
		/*
		 * Create an expandable byte array to hold the compressed data. You cannot use
		 * an array that's the same size as the orginal because there is no guarantee
		 * that the compressed data will be smaller than the uncompressed data.
		 */
