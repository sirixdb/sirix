...
public interface PageReadOnlyTrx extends AutoCloseable {
	 ...
	 *
	 * @param indexLogKey
	 *            it has the key {@code key} of key/value page to get the record
	 *            from, the index number or {@code -1}, if it's a regular record
	 *            page to lookup and the kind of page to lookup
	 ...
	 *
	 * @param recordKey
	 *            record key to find record page key for
	 * @param indexType
	 *            the index type
	 ...
	 *
	 * @param revisionRoot
	 *            {@link RevisionRootPage} for which to get the {@link DeweyIDPage}
	 ...
	 * @param indexNumber
	 *            the index number or {@code -1}
	 * @param indexType
	 *            the index type
	 * @param revisionRootPage
	 *            the revision root page (may be {@code null})
	 ...
	 *
	 * @param indirectPageReference
	 *            The indirect page reference.
	 ...
	 *
	 * @param page
	 *            the page to read the record from
	 * @param nodeKey
	 *            the node key of the record to read
