...
public interface NodeTrx extends NodeReadOnlyTrx, AutoCloseable {
	...
	/**
	 * Commit all modifications of the exclusive write transaction. Even commit if
	 * there are no modification at all. The author assignes a commit message.
	 *
	 * @param commitMessage
	 *            message of the commit
	 * @return NodeTrx return current instance
	 * @throws SirixException
	 *             if this revision couldn't be committed
	 */
	 ...
	 *
	 * @return the page read-write transaction used for reading pages from the index
	 *         structure(s)
	 */
	PageTrx getPageWtx();
