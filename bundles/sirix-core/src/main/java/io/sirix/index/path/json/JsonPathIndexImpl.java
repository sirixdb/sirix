...
public final class JsonPathIndexImpl implements JsonPathIndex {
	...
	@Override
	public JsonPathIndexBuilder createBuilder(final PageTrx pageTrx, final PathSummaryReader pathSummaryReader,
	...
	@Override
	public JsonPathIndexListener createListener(final PageTrx pageTrx, final PathSummaryReader pathSummaryReader,
			final IndexDef indexDef) {
