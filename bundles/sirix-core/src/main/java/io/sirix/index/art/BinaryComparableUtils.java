...
class BinaryComparableUtils {
	...
	/**
	 * For Node4, Node16 to interpret every byte as unsigned when storing partial
	 * keys. Node 48, Node256 simply use {@link Byte#toUnsignedInt(byte)} to index
	 * into their key arrays.
	 */
