...
abstract class Node {
  /**
   * @return child pointer for the smallest partialKey stored in this Node. Returns null if this node
   *         has no children.
   */
  abstract Node first();
  ...
  /**
   * @return child pointer for the largest partialKey stored in this Node. Returns null if this node
   *         has no children.
   */
  abstract Node last();
