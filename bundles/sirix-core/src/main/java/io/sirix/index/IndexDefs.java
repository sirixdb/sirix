...
public final class IndexDefs {
	...
	public static IndexDef createNameIdxDef(final int indexDefNo, final IndexDef.DbType dbType) {
		return switch (dbType) {
			case JSON -> new IndexDef(ImmutableSet.of(), ImmutableSet.of(),
					PageConstants.JSON_NAME_INDEX_OFFSET + indexDefNo, dbType);
			case XML -> new IndexDef(ImmutableSet.of(), ImmutableSet.of(),
					PageConstants.XML_NAME_INDEX_OFFSET + indexDefNo, dbType);
		};
	}
	...
	public static IndexDef createFilteredNameIdxDef(final Set<QNm> excluded, final int indexDefNo,
		...
		return switch (dbType) {
			case JSON ->
				new IndexDef(ImmutableSet.of(), excluded, PageConstants.JSON_NAME_INDEX_OFFSET + indexDefNo, dbType);
			case XML ->
				new IndexDef(ImmutableSet.of(), excluded, PageConstants.XML_NAME_INDEX_OFFSET + indexDefNo, dbType);
		};
	}
	...
	public static IndexDef createSelectiveNameIdxDef(final Set<QNm> included, final int indexDefNo,
		...
		return switch (dbType) {
			case JSON ->
				new IndexDef(included, ImmutableSet.of(), PageConstants.JSON_NAME_INDEX_OFFSET + indexDefNo, dbType);
			case XML ->
				new IndexDef(included, ImmutableSet.of(), PageConstants.XML_NAME_INDEX_OFFSET + indexDefNo, dbType);
		};
	}
}
