...
public final class XmlNameIndexImpl implements XmlNameIndex {
	...
	@Override
	public XmlNameIndexBuilder createBuilder(final PageTrx pageWriteTrx, final IndexDef indexDef) {
	...
	@Override
	public XmlNameIndexListener createListener(final PageTrx pageWriteTrx, final IndexDef indexDef) {
