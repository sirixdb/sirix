 ...
 * <p>
 * This indicates that the buffer manager evicted and recycled the page frame (incrementing its
 * version counter) while a transaction was still holding a guard. The caller should retry the
 * operation to reload the correct page.
 * <p>
