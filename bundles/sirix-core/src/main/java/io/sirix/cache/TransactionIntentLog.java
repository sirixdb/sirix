...
/**
 * The transaction intent log, used for caching everything the
 * read/write-transaction changes.
 *
...
public final class TransactionIntentLog implements AutoCloseable {
	 ...
	 *
	 * @param maxInMemoryCapacity
	 *            the maximum size of the in-memory map
	 */
