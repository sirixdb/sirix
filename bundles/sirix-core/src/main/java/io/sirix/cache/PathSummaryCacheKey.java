...
/**
 * Composite cache key for PathSummaryCache to support global BufferManager. Includes database ID
 * and resource ID to uniquely identify path summary data across all databases and resources.
 *
