...
public final class Util {
	 ...
	 * @param axis
	 *            the {@link Axis}
	 * @return the next result of the axis. If the axis has no next result, the null
	 ...
	 * Returns true for a node and throws an exception for an atomic value, because
	 * these are not allowed in the except expression.
	 *
	 * @param nodeKey
