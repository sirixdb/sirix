...
/**
 * A registry for write locks used for {@link ResourceSession resource
 * managers}.
 *
 * <p>
 * Each {@link ResourceSession}, identified by its {@link Path resource path},
...
public class WriteLocksRegistry {
	 ...
	 *
	 * <p>
	 * This method will create a new write lock if no lock exists for the provided
	 * resource.
	 *
	 * @param resourcePath
