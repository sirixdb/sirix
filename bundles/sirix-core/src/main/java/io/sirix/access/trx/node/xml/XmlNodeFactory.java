...
public interface XmlNodeFactory extends NodeFactory {
	 ...
	 * @param pathNodeKey
	 *            path node key associated with the element node
	 * @param id
	 *            optional DeweyID
	 * @return the created node
	 * @throws SirixIOException
	 ...
	 *             if an I/O error occurs
	 */
	AttributeNode createAttributeNode(@NonNegative long parentKey, QNm name, byte[] value,
			@NonNegative long pathNodeKey, SirixDeweyID id);
