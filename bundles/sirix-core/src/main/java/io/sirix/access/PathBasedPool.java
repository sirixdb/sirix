...
public class PathBasedPool<E> {
	 ...
	 *
	 * @param file
	 *            the file that identifies the object.
	 * @param object
	 *            object to be persisted to the pool.
	 */
	 ...
	 *
	 * @param file
	 *            The file which might have registered objects.
	 * @return {@code true} if the provided {@code file} has 1 or more registered
	 *         objects.
	 */
	...
	private Set<E> append(final Path path, @Nullable final Set<E> objects, final E object) {
