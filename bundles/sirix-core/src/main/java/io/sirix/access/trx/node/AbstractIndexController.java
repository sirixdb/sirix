...
public abstract class AbstractIndexController<R extends NodeReadOnlyTrx & NodeCursor, W extends NodeTrx & NodeCursor>
	 ...
	 * @param pathIndex
	 *            the path index manager
	 * @param casIndex
	 *            the CAS index manager
	 * @param nameIndex
	 *            the name index manager
	 */
	...
	private ChangeListener createPathIndexListener(final PageTrx pageWriteTrx,
