 ...
 * 
 * <p>
 * This class implements a bump allocator pattern (similar to RocksDB's Arena and DuckDB's
 * ArenaAllocator) where memory is allocated from large blocks with O(1) allocation cost. All memory
 * is freed in bulk when the arena is closed.
 * </p>
 * 
 * <p>
 * Key properties:
 ...
 * 
 * <p>
 * Thread safety: This class is NOT thread-safe. It is designed to be used by a single transaction
 * thread. The underlying Arena.ofConfined() enforces this.
 * </p>
 * 
...
public final class TransactionArena implements AutoCloseable {
   ...
   * 
   * <p>
   * The returned segment is 8-byte aligned and valid until the arena is closed.
   * </p>
   * 
   ...
   * 
   * <p>
   * This is more efficient than creating a new arena because it reuses already-allocated blocks.
   * Useful for auto-commit windows where the transaction continues after committing.
   * </p>
   */
  public void reset() {
    if (closed) {
   ...
   * 
   * <p>
   * After calling close(), all MemorySegments allocated from this arena become invalid and must not
   * be accessed.
   * </p>
   */
  @Override
