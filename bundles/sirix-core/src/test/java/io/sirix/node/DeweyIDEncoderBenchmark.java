 ...
 * 
 * <p>
 * This is not a proper JMH benchmark but provides a quick sanity check that the optimized encoder
...
class DeweyIDEncoderBenchmark {
  ...
  void benchmarkEncoder() {
    ...
    System.out.printf("Throughput: %,.0f bytes/second (%.2f MB/s)%n", bytesPerSecond, bytesPerSecond / 1_000_000.0);
  }
