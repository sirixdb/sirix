...
//
// public class ARTIntegerTest extends AbstractNavigableMapTest<Integer,
// Integer> {
//
...
// 0xFFFFFF03, // add two more with same 3 prefix bytes to cause growth to
// Node16
// 0xFFFFFF04,
// 0xFF000000, // incomplete compressed path match (branch out), update
// compressed path to FF
// // and only FF for first 5 nodes
// 0xFF000001, // complete compressed path match FF
// // deleting all previous would leave two children of FE and none with FF and
// hence
// // cause updating only child of FF and refer directly to 00, 01 having CP as
// FE
// 0xFFFE0000,
// 0xFFFE0001,
