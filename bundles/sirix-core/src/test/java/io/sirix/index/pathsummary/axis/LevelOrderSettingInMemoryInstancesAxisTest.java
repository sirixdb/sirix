...
public final class LevelOrderSettingInMemoryInstancesAxisTest {
	...
	public void testInsertedTestDocument() {
		try (final var database = JsonTestHelper.getDatabase(JsonTestHelper.PATHS.PATH1.getFile());
			...
			final var pathSummaryAxis = new LevelOrderSettingInMemoryInstancesAxis.Builder(pathSummary).includeSelf()
					.build();
	...
	private static void checkPathNode(PathSummaryReader pathSummary,
			LevelOrderSettingInMemoryInstancesAxis pathSummaryAxis, long nodeKey, String path, int references,
			int level) {
