...
//
// public class ARTInetAddressTest extends
// AbstractNavigableMapShortTest<InetAddress, String> {
...
// private static final String[] otherSampleValues =
// generateOtherSampleValues();
//
...
// String address = r.nextInt(256) + "." + r.nextInt(256) + "." + r.nextInt(256)
// + "." + r.nextInt(256);
// try {
...
// InputStreamReader(ARTInetAddressTest.class
