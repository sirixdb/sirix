...
//
// public abstract class AbstractNavigableSetTest<K> extends
// org.apache.commons.collections4.set.AbstractNavigableSetTest<K> {
...
// Assert.assertEquals(this.getCollection().pollFirst(),
// this.getConfirmed().pollFirst());
// verify();
// }
// verify();
// }
...
// resetFull();
// while (!this.getCollection().isEmpty()) {
// Assert.assertEquals(this.getCollection().pollLast(),
// this.getConfirmed().pollLast());
// verify();
// }
// verify();
// }
...
// public class TestNavigableSetSubSet extends
// org.apache.commons.collections4.set.AbstractNavigableSetTest.TestNavigableSetSubSet
// {
//
...
// }
//
// public class TestSortedSetSubSet extends
// org.apache.commons.collections4.set.AbstractSortedSetTest.TestSortedSetSubSet
// {
//
