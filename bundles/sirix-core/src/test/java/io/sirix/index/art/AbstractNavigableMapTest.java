...
// import java.util.*;
//
// public abstract class AbstractNavigableMapTest<K, V> extends
...
// }
//
// // if provided object to entrySet is not an "entry" then we always return
// false
// public void testEntrySetContainsForNonEntryObject() {
// resetFull();
// Object ob = new Object();
// assertEquals(this.getConfirmed().entrySet().contains(ob),
// this.getMap().entrySet().contains(ob));
// }
//
...
// assertEquals(this.getConfirmed().higherEntry(key),
// this.getMap().higherEntry(key));
// assertEquals(this.getConfirmed().higherKey(key),
// this.getMap().higherKey(key));
// }
// }
//
...
// assertEquals(this.getConfirmed().pollFirstEntry(),
// this.getMap().pollFirstEntry());
// if (!shortTest) {
// verify();
// }
// }
...
// resetFull();
// while (!this.getMap().isEmpty()) {
// assertEquals(this.getConfirmed().pollLastEntry(),
// this.getMap().pollLastEntry());
// if (!shortTest) {
// verify();
// }
// }
...
// assertEquals(this.getMap().remove(keys[i]),
...
// V[] values = this.getSampleValues();
// for (int i = 0; i < this.getMap().size(); i++) {
// assertEquals(this.getConfirmed().remove(keys[i]),
// this.getMap().remove(keys[i]));
...
//
// /*
// copy of Entry is needed because Map.Entry is undefined after the map is
// modified.
...
// }
//
// public static class TestNavigableKeySet<K, V> extends
// AbstractNavigableSetTest<K> {
...
// }
//
// public static class TestDescendingMap<K, V> extends
...
// }
//
// // TODO: explain the need (TestHeadMap doesn't override makeConfirmedMap to
// main's impl)
// public static class TestHeadMap<K, V> extends
...
// }
//
// public static class TestSubMap<K, V> extends
...
// }
//
// public static class TestTailMap<K, V> extends
