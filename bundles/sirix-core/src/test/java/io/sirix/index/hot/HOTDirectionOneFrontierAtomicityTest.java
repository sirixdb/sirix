...
@ResourceLock("HOT_DIRECTION_ONE_FRONTIER_AFTER_PUBLICATION_TEST_HOOK")
final class HOTDirectionOneFrontierAtomicityTest {

  private static final String RESOURCE_NAME = "hot-direction-one-frontier-atomicity";
  ...
  void postPublicationFailurePoisonsWriterUntilRollback() {
    final IllegalStateException sentinel = new IllegalStateException("injected after frontier publication");
