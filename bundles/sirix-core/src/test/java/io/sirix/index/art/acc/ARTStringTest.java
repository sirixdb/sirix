...
// (since fooooooooz, fooooooood would've been removed already when removing
// fooooooooe)
//
...
// Object[] result = new String[] {"fooooooooz", "fooooooood", "fooooooooe",
// "fooooooooee", "baaar", "baaaz", "tmp", "baoz", "hello", "goodbye", "we'll",
// "see", "you", "all", "", "key", "key2", "nonnullkey"};
// return (String[]) result;
// }
//
// // For replaced by foooe to cause higherKey to match against compressed path
// of "fooooooooz",
// // "fooooooood", "fooooooooe" and then be less than compressed path and hence
// get first on the level.
// // ideally we should include a separate test with such set special set of
// keys
// // inducing the behaviour.
// // for now we change the sample keys
// @Override
// public Object[] getOtherNonNullStringElements() {
// return new Object[] {"foooe", "then", "despite", "space", "I", "would", "be",
