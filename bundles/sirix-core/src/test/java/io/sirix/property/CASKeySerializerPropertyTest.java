...
final class CASKeySerializerPropertyTest {
   ...
   * brackit's inversion. It is recorded rather than encoded: the canonical index's byte ordering
   * and {@code CASFilterRange#inRange}'s Brackit comparator disagree on boolean range order.
   * </p>
   */
  @Provide
