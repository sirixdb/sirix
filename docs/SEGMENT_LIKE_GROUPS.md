...
Both queries retain the exact routes and marked-cell/distinct-rank counters listed above.
Both serialized outputs are byte-identical (`diff -r` exit 0), with SHA-256:
